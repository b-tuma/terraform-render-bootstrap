...
variable "container_images" {
  ...
  default = {
    ...
    cilium_agent            = "quay.io/cilium/cilium:v1.11.0"
    cilium_operator         = "quay.io/cilium/operator-generic:v1.11.0"
    ...
    kube_apiserver          = "k8s.gcr.io/kube-apiserver:v1.23.1"
    kube_controller_manager = "k8s.gcr.io/kube-controller-manager:v1.23.1"
    kube_scheduler          = "k8s.gcr.io/kube-scheduler:v1.23.1"
    kube_proxy              = "k8s.gcr.io/kube-proxy:v1.23.1"
  }
}
